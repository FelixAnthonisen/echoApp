...
struct Happening: Decodable {
    ...
    static let queryAll = client.query([Happening].self, query: nextQuery)
    static let queryListen = client.query(Happening.self, query: nextQuery)
...
/*class NextFetcher: ObservableObject {
